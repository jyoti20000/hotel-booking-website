            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customer well be allowed to book hotel rooms when shutdown is turned on.
                        </p>
                    </div>
                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">
                                                        Phone Numbers(with country with code)
   ...
   <script src="scripts/settings.js"></script>
    ...
    <!-- <script>
        ...
        general_s_form.addEventListener('submit', function (e) {
            e.preventDefault();    //this is avoid to refresh the page
        ...
        function add_member() {
            ...
            xhr.onload = function () {
                ...
                if (this.responseText == 'inv_img') {
                    alert('error', 'Only JPG & PNG format are allowed!');
