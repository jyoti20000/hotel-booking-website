...
<body class="bg-light">
  ...
  $u_exist = select("SELECT * FROM `user_cred1` WHERE `id`=? LIMIT 1", [$_SESSION['uId']], 's');
  ...
  <div class="container">
    <div class="row">
          ...
          <form id="info-form">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input name="name" type="text" value="<?php echo $u_fetch['name'] ?>" class="form-control shadow-none"
                  required>
              </div>
              <div class="col-md-4 mb-3">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="dob" type="date" value="<?php echo $u_fetch['dob'] ?>" class="form-control shadow-none"
                  required>
              </div>
              <div class="col-md-4 mb-3">
      ...
      <div class="col-md-4 mb-5  px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="profile-form">
            ...
            <!-- img-fluid gives the 100% width to img -->
      ...
      <div class="col-md-8 mb-5  px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="pass-form">
            <h5 class="mb-3 fw-bold">Change Paasword</h5>
            <div class="row">
  ...
  <script>
    ...
    info_form.addEventListener('submit', function (e) {
      ...
      xhr.open("POST", "ajax1/profile1.php", true);
    ...
    pass_form.addEventListener('submit', function (e) {
      ...
      xhr.onload = function () {
        if (this.responseText == 'mismatch') {
          alert('error', "Password do not mached!");
        }
