<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 ffw-bold fs-3 h-font " href="index.php">
            ...
            <form id="login-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: You have to do the Registration before login.
                    </span>
                    <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <!-- <a href="javascript: void(0)" class="text-secondary text-decoration-none"></a> -->
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="forgot-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: Please Enter your Email-id or Phone Number to Find Your Account.
                    </span>
                    <?php echo  @$msg; ?>
                    <div class="mb-4">
                        <label class="form-label">Email / Mobile</label>
                    ...
                    <div class="mb-2 align-items-center justify-content-between mb-2 text-end">
            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center my-1">
                        <!--<button type="submit" class="btn btn-dark shadow-none">Register Now</button> -->
                        <button type="submit" class="btn btn-primary shadow-none">Register Now</button>
                    </div>
