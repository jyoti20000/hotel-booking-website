...
<h6 class="text-center bg-dark text-white p-3 m-0"> Designed and Developed by Gjyoti Sharma</h6>
...
<script>
    ...
    register_form.addEventListener('submit', (e)=>{
        ...
        xhr.open("POST", "ajax1/login_register.php", true);
    ...
    let data = new FormData();
        data.append('email_mob', forgot_form.elements['email_mob'].value);
