<?php
   ...
   session_start();
    ...
    if(isset($_POST['review_form']))
    {
       ...
       $ins_query = "INSERT INTO `rating_review`(`booking_id`, `room_id`, `user_id`, `review`, `rating`) VALUES (?,?,?,?,?)";

       $ins_values = [$frm_data['booking_id'],$frm_data['room_id'],$_SESSION['uId'],$frm_data['review'],$frm_data['rating']];

       $ins_result = insert($ins_query,$ins_values,'iiisi');
