...
<body class="bg-light">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-3 col-md-12 mb-lg-0  mb-4 ps-4 px-0">
          ...
          <div class="container-fluid flex-lg-column align-items-stretch ">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 19px;">
                  <span>CHECK AVAILABILITY</span>
                  <button id="chk_avail_btn" onclick="chk_avail_clear()"
                    class="btn btn-sm text-primary d-none shadow-none">Reset</button>
                </h5>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="d-flex">
                  ...
                  <div>
                    ...
                    <input type="number" min="1" id="children" value="<?php echo $children_default ?>" oninput="guests_filter()"
  ...
  <script>
    ...
    function fetch_rooms() {
      ...
      xhr.open("GET", "ajax1/rooms1.php?fetch_rooms&chk_avail=" + chk_avail + "&guests=" + guests+"&facility_list="+facility_list, true);
